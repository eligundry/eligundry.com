...
cover: ../../assets/img/job-search-2k22/sankey-chart.png
tags:
  - code
---

import JobSearchSankeyChart from '../../components/JobSearchSankeyChart/index.astro'

export const components = { JobSearchSankeyChart }
...
![Chord Commerce Logo](../../assets/img/job-search-2k22/chord-logo.jpg)
