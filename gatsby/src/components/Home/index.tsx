...
const Section = styled.section<SectionProps>`
  ${tw`hero w-screen h-screen`}

  & > .content {
    ${tw`hero-content flex-row`}
    ${({ flexRow }) => (flexRow ? tw`flex-row` : tw`flex-col`)}
  }
...
const Home: React.FC = () => {
  ...
  return (
    <>
      <Section className="introduction-hero" flexRow>
        <div className="content">
          <div>
            ...
            <ul>
              ...
              <li>
                Die hard Cleveland Browns fan and am convinced that we will win
                a Super Bowl one of these years.
              </li>
              <li>
      ...
      <Section className="coding">
        <div className="content">
          ...
          <p className="summary">
            ...
            stack and will do whatever it takes to ship. Need me to do some
            devops to get this feature out? I gotcha. Some CSS is making a
            button look bad? I'll do my best. A query running to slow? Stop, I
            can't deal with all this excitement.
          </p>
          <p>
      ...
      <Section className="blogging" flexRow>
        <h2>Blogging</h2>
      ...
      <Section className="reading">
        <div className="content">
          <h2>Reading</h2>
          <p className="summary">
            I wish I read more, but there are only so many hours in the day.
            These are the books that I'm reading right now. You can find me on{' '}
            <a
