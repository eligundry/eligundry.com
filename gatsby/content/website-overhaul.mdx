...
https://www.npmjs.com/package/@eligundry/gatsby-source-goodreads
...
* Dark Theme
  ...
  * Components react to color theme changes, even external ones
* Fluid pattern background
  * Shamelessly stolen from https://codepen.io/georgedoescode/pen/YzxrRZe
  * Can be regenerated with the button on the bottom right corner of the page
