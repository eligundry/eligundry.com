...
type memesFieldsEnum =
  ...
  | 'image.childrenMarkdownRemark.frontmatter.cover'
...
type UseMemesQuery = { readonly allMemes: { readonly memes: ReadonlyArray<(
      Pick<memes, 'id' | 'notes' | 'size' | 'url' | 'created_at'>
