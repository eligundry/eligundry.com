...
to Visual Studio Code than Neovim. It was great when the Neovim LSP space was somewhat immature. With that said, Neovim's
...
<DemoVideo
  src="/img/neovim-lua/lsp-completion.webm"
...
I get a little preview of the file. And Telescope can search files for strings, buffers and more!

You have to see it to believe it!

<DemoVideo
  src="/img/neovim-lua/telescope.webm"
...
Moving to Lua allowed me to do a bunch of things that seemed impossible in Vimscript relatively easy for me.
...
<GitHubFile
  expanded
  fileURL="https://github.com/eligundry/dots/blob/eeed2f2fcbf3c1aa02b6981e2abea746b1c50cd6/config/nvim/init.lua#L647-L684"
/>

Below is a video of me calling that function with <kbd>,rn</kbd> in normal mode.

<DemoVideo
  src="/img/neovim-lua/numbering-modes.webm"
...
<GitHubFile
  expanded
  fileURL="https://github.com/eligundry/dots/blob/eeed2f2fcbf3c1aa02b6981e2abea746b1c50cd6/config/nvim/init.lua#L802-L850"
/>
...
<GitHubFile
  expanded
  fileURL="https://github.com/eligundry/dots/blob/eeed2f2fcbf3c1aa02b6981e2abea746b1c50cd6/config/nvim/init.lua#L852-L857"
/>

By pressing <kbd>,hi</kbd>, I get a paragraph of the finest hipsum!

<DemoVideo
  src="/img/neovim-lua/hipster-ipsum.webm"
