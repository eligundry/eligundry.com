...
slug: neovim-lua
cover: /img/neovim-lua/friendship-ended-with-vimscript.png
...
!["Friendship ended with Vimscript, Now Lua is my best friend" meme](/img/neovim-lua/friendship-ended-with-vimscript.png)
