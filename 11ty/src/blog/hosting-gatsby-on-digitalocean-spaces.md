...
postTags:
  - code
---
{% image './img/gatsby-digitialocean-spaces/grimace-cover.png', 'Hosting Gatsby on DigitalOcean Spaces will make you grimmace' %}
...
{% image './img/gatsby-digitialocean-spaces/do-spaces-gzip-lie.png', 'The gzip lie' %}
...
{% image './img/gatsby-digitialocean-spaces/do-spaces-waterfall.png', 'My site on DigitalOcean Spaces connection waterfall. There is a lot of stalling.' %}
...
{% image './img/gatsby-digitialocean-spaces/do-spaces-lighthouse-100.png', ':100: from Lighthouse' %}

I was able to get a 100 from Lighthouse! But at what cost?

{% image './img/gatsby-digitialocean-spaces/do-spaces-lighthouse-no-http2.png', 'No HTTP/2 from DigitalOcean Spaces hurt me' %}
...
{% image './img/gatsby-digitialocean-spaces/netlify-waterfall.png', 'My site on Netlify connection waterfall. All the JS and images end up fetching concurrently!' %}
